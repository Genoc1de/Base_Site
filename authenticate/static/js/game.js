(function() {
  ...
  Game.prototype.setScore = function(){
    $(".score").html("Счет:" + " " + this.board.score);
  };
  ...
  Game.prototype.win = function(){
    var modal = ("<div class='modal-text'><p>Поздравляю, вы победили! Хотите сыграть еще раз?</p><div class='modal-button'><button>Играть снова</button></div></div></div>");
    $(".modal").html(modal);
    $(".modal-button").on("click", this.newGame.bind(this));
  };

  Game.prototype.lose = function(){
    var modal = ("<div class='modal-text'><p>Игра окончена.  Ваш счет " + this.board.score + ". Хотите сыграть еще раз?</p><div class='modal-button'><button>Играть снова</button></div></div></div>");
    $(".modal").html(modal);
    $(".modal-button").on("click", this.newGame.bind(this));
  };
